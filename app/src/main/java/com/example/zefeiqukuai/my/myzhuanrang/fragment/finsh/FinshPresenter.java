...
public class FinshPresenter extends BasePresenter<FinshView> {


    private DealBean dealBean;

    public FinshPresenter(Context context) {
        super(context);
    }
        ...
        RetrofitUtil.getInstance().toSubscribe(observable, new OnMyCallBack(new OnDataListener() {
            ...
            public void onSuccess(String result, String msg) {
                ...
                if (result != null) {
                    ...
                    dataBeans.addAll(FinshPresenter.this.dealBean.getData());
                    if (dealAdapter == null) {
