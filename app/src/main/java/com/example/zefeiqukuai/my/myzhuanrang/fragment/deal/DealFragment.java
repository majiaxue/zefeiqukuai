...
public class DealFragment extends BaseFragment<DealView, DealPresenter> implements DealView {
    ...
    public DealPresenter createPresenter() {
        return new DealPresenter(getContext());
    }
}
