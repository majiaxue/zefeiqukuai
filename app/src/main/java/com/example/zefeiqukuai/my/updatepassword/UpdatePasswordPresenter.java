...
public class UpdatePasswordPresenter extends BasePresenter<UpdatePasswordView> {
    ...
    public void updatePassword(String code,String password)
    {
        ...
        Observable observable = RetrofitUtil.getInstance().getApi(CommonResource.BASEURL_8089).postHeadWithBody(CommonResource.UPPWD, body, SPUtil.getStringValue(CommonResource.TOKEN));
