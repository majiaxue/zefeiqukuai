...
public class UpdatePasswordPayActivity extends BaseActivity<UpdatePasswordPayView, UpdatePasswordPayPresenter> implements UpdatePasswordPayView {
    ...
    public void initClick() {
        ...
        loginBtnLogin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                {
                    Toast.makeText(UpdatePasswordPayActivity.this, "请输入正确的手机号", Toast.LENGTH_SHORT).show();
                }else if (TextUtils.isEmpty(updatepwdCode.getText().toString()))
                {
                    Toast.makeText(UpdatePasswordPayActivity.this, "请输入验证码", Toast.LENGTH_SHORT).show();
                }else if (TextUtils.isEmpty(updatepwdNew.getText().toString()))
                {
                    Toast.makeText(UpdatePasswordPayActivity.this, "请输入新密码", Toast.LENGTH_SHORT).show();
    ...
    @Override
    public UpdatePasswordPayView createView() {
        return this;
    }

    @Override
    public UpdatePasswordPayPresenter createPresenter() {
        return new UpdatePasswordPayPresenter(this);
    }
