...
public class MyTeamAdapter2 extends MyRecyclerAdapter<MyTeamBean.Gener2Bean> {
    public MyTeamAdapter2(Context context, List<MyTeamBean.Gener2Bean> mList, int mLayoutId) {
        super(context, mList, mLayoutId);
    }
    @Override
    public void convert(RecyclerViewHolder holder, MyTeamBean.Gener2Bean data, int position) {
